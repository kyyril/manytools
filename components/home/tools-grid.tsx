  ...
  return (
    <section className="py-16 container">
      <div className="mb-12 text-center">
        <h2 className="text-3xl font-bold tracking-tight mb-4">Our AI-Powered Tools</h2>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Access a comprehensive suite of AI tools designed to enhance your writing and content creation process.
        </p>
      </div>
      ...
      >
        {tools.map((tool) => (
          <motion.div key={tool.id} variants={item}>
            <Card className="h-full cursor-pointer transition-all duration-300 hover:shadow-lg hover:scale-[1.02]" onClick={() => router.push(tool.path)}>
              <CardHeader>
              ...
              <CardFooter>
                <Button variant="ghost" className="w-full justify-start">Try Now</Button>
              </CardFooter>
            </Card>
          </motion.div>
        ))}
